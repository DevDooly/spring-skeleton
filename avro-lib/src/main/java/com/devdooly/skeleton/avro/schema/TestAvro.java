...
public class TestAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2840995662520342106L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TestAvro\",\"namespace\":\"com.devdooly.skeleton.avro.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public TestAvro(java.lang.Long id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static com.devdooly.skeleton.avro.schema.TestAvro.Builder newBuilder() {
    return new com.devdooly.skeleton.avro.schema.TestAvro.Builder();
  }
   ...
   * @return A new TestAvro RecordBuilder
   */
  public static com.devdooly.skeleton.avro.schema.TestAvro.Builder newBuilder(com.devdooly.skeleton.avro.schema.TestAvro.Builder other) {
    if (other == null) {
      return new com.devdooly.skeleton.avro.schema.TestAvro.Builder();
    } else {
      return new com.devdooly.skeleton.avro.schema.TestAvro.Builder(other);
    }
  }
   ...
   * @return A new TestAvro RecordBuilder
   */
  public static com.devdooly.skeleton.avro.schema.TestAvro.Builder newBuilder(com.devdooly.skeleton.avro.schema.TestAvro other) {
    if (other == null) {
      return new com.devdooly.skeleton.avro.schema.TestAvro.Builder();
    } else {
      return new com.devdooly.skeleton.avro.schema.TestAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.devdooly.skeleton.avro.schema.TestAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.devdooly.skeleton.avro.schema.TestAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.devdooly.skeleton.avro.schema.TestAvro.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.devdooly.skeleton.avro.schema.TestAvro.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.devdooly.skeleton.avro.schema.TestAvro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.devdooly.skeleton.avro.schema.TestAvro.Builder clearName() {
      name = null;
